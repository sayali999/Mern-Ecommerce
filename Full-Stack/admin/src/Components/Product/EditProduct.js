...
export default function EditProduct() {
    ...
    const editData = async () => {
        try {
            ...
            if (data.success) {
                ...
                setsubcategory(data.products.subcategory._id);
                setquantity(data.products.quantity);

                setProdid(data.products._id);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.put(`http://localhost:5000/api/form/update-product/${prodid}`,productData);
              if (data?.success) {
            ...
            <div className='p-5'>
                <nav id='breadcrumb' aria-label="breadcrumb" className=' py-2 fw-bold'>
                    <ol className="breadcrumb">
                        <li>
                            <span className="text-decoration-none text-dark px-2">Edit Product</span> | </li>
                    ...
                    <div className="col-sm-12 px-3">
                        ...
                        <form className='row g-3 px-4 py-4'>
                            ...
                            {photo ? (
                                ...
                                <div>
                                    <img src={`http://localhost:5000/api/form/product-photo/${prodid}`} height={"200px"} />
